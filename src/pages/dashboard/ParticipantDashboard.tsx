                        ...
                        return (
                            <div key={event.id} className="grid grid-cols-12 gap-0 md:gap-4 group">
                                ...
                                <button 
                                    ...
                                    className="w-full text-left p-1 pr-6 cursor-pointer hover:shadow-2xl hover:shadow-indigo-500/10 border border-slate-100 rounded-[24px] group-hover:border-indigo-200 transition-all duration-500 overflow-hidden bg-white/80 backdrop-blur-md"
                                >
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <div className="flex -space-x-3">
                                                            ...
                                                            <div className="w-9 h-9 rounded-xl border-2 border-white bg-indigo-600 flex items-center justify-center text-[10px] font-black text-white shadow-lg shadow-indigo-200">
                                                                +{Math.abs(event.id.split('').reduce((acc, char) => acc + (char.codePointAt(0) || 0), 0) % 50) + 20}
                                                            </div>
                                                        </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                        Acara{' '}
                        <span className="w-2 h-10 bg-indigo-600 rounded-full animate-pulse hidden md:block" aria-hidden="true"></span>
                    </h1>
                </div>
